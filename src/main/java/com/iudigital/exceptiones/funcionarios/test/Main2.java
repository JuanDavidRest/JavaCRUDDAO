...
//mostrar todos los funcionarios creados
 private void addListener() {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 30, 210, -1));
        ...
        lblIdentidad.setText("Nro Identificación");
        JPFuncionario2.add(lblIdentidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 100, -1));

        lblUniversidad.setText("IES de Universidad");
        JPFuncionario2.add(lblUniversidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 40, -1, -1));

        lblName.setText("Nombre ");
        JPFuncionario2.add(lblName, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 40, -1, -1));

        lblApellido.setText("Apellido ");
        JPFuncionario2.add(lblApellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 40, 70, -1));

        lblEstadocivil.setText("Estado civil");
        JPFuncionario2.add(lblEstadocivil, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 40, -1, -1));

        LBLSexo.setText("Género");
        JPFuncionario2.add(LBLSexo, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 120, -1, -1));

        lblFecha.setText("Fecha Nacimiento");
        JPFuncionario2.add(lblFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 120, -1, 20));

        lblPariente.setText("Id del Familiar");
        JPFuncionario2.add(lblPariente, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, -1, -1));
        lblPariente.getAccessibleContext().setAccessibleName("id del familiar");

        lblDireccion.setText("Dirección");
        JPFuncionario2.add(lblDireccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 120, -1, -1));

        lblTelefono.setText("Telefono");
        JPFuncionario2.add(lblTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 120, -1, -1));
        JPFuncionario2.add(txtIdentificacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 100, -1));
        JPFuncionario2.add(txtUniversity, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 60, 100, -1));
        ...
        JPFuncionario2.add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 60, 100, -1));
        JPFuncionario2.add(txtApellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 60, 100, -1));
        ...
        JPFuncionario2.add(txtEstadocivil, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 60, 100, -1));
        JPFuncionario2.add(txtSexo, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, 100, -1));
        JPFuncionario2.add(txtDireccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 140, 100, -1));
        ...
        JPFuncionario2.add(txtFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 140, 100, -1));
        JPFuncionario2.add(txtPariente, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 100, -1));
        JPFuncionario2.add(TxtFamiliar, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 200, 155, -1));
        ...
        JPFuncionario2.add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 240, -1, -1));

        lblFamiliar2.setText("Nro Identificacion del familiar");
        JPFuncionario2.add(lblFamiliar2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 180, -1, -1));
        lblFamiliar2.getAccessibleContext().setAccessibleName("Nro de identificación del familiar");
        ...
        JPFuncionario2.add(txtTelefono1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 140, 100, -1));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 20, 70, 20));
        ...
        jPanel1.add(cbxFuncionario, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 40, 100, -1));

        btnActualizar.setText("Actualizar");
        jPanel1.add(btnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 250, -1, -1));

        btnEliminar.setText("Eliminar");
        jPanel1.add(btnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 280, 80, -1));
        ...
        jPanel1.add(lblUniversidad1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 100, -1, -1));
        ...
        jPanel1.add(lblApellido1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 100, -1, -1));

        lblEstadocivil1.setText("Estado civil");
        jPanel1.add(lblEstadocivil1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 220, -1, -1));

        LBLSexo1.setText("Género");
        jPanel1.add(LBLSexo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 160, -1, -1));

        lblDireccion1.setText("Direccion");
        jPanel1.add(lblDireccion1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 160, -1, -1));

        lblTelefono1.setText("Telefono");
        jPanel1.add(lblTelefono1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 160, -1, -1));

        lblPariente1.setText("Id");
        jPanel1.add(lblPariente1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, -1, -1));

        lblFamiliar1.setText("Nro Id Familiar");
        jPanel1.add(lblFamiliar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 220, -1, -1));

        lblFecha1.setText("Fecha Nacimiento");
        jPanel1.add(lblFecha1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 160, -1, -1));

        lblIdentidad1.setText("Nro Identificación");
        jPanel1.add(lblIdentidad1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 100, -1, -1));
        jPanel1.add(txtIdfuncionario, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 120, 40, -1));
        jPanel1.add(txtIdenticacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 120, 100, -1));
        jPanel1.add(txtUniversidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 120, 100, -1));
        jPanel1.add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 120, 100, -1));
        jPanel1.add(txtApellido1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 120, 100, -1));
        jPanel1.add(txtEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 240, 100, -1));
        jPanel1.add(txtGenero, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 180, 100, -1));
        jPanel1.add(txtDireccion1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 180, 100, -1));
        jPanel1.add(txtTelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 180, 100, -1));
        jPanel1.add(txtFecha1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 180, 100, -1));
        jPanel1.add(txtPariente1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 40, -1));
        jPanel1.add(txtFamilia, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 240, 100, -1));
